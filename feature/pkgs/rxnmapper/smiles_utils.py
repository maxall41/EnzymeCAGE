...
def generate_atom_mapped_reaction_atoms(
    ...
    precursors_mols = [Chem.MolFromSmiles(pr) for pr in reactants + agents]
    products_mols = [Chem.MolFromSmiles(prod) for prod in products]
    # print(Chem.MolToSmiles(precursors_mols[0]))
    ...
    for precursor_mol in precursors_mols:
        ...
        atom_mapped_precursors_list.append(
            ...
            Chem.MolToSmiles(precursor_mol)
        )
        # print(atom_mapped_precursors_list)
